...
class YesNoModel {
  final String answer; // 'yes | 'np' | 'maybe', tal cual lo manda la API
  final bool forced;
  final String image;
  ...
  factory YesNoModel.fromJson(Map<String, dynamic> json) {
    return YesNoModel(
      answer:
          json['answer']
              as String, // 'as String' valida el tipo en tiempo de ejecucion
  ...
  Message toEntity() {
    ...
    return Message(text: text, sender: MessageSender.oracle, imageUrl: image);
  }
}
